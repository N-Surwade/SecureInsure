<?php
// buy_life.php - Life policy purchase form
session_start();
...
if (isset($_GET['policy'])) {
    ...
    $stmt = $conn->prepare("SELECT policy_name, premium FROM policies WHERE id = ? AND type = 'Life'");
...
<body>
    ...
    <main class="container">
        <h1>Life Insurance - <?php echo htmlspecialchars($policy_name); ?></h1>
        <div class="card">
        ...
        <?php else: ?>
            ...
            <form class="flex-form" action="process_buy.php" method="POST">
                ...
                <input type="hidden" name="policy_type" value="Life">
                <input type="hidden" name="return_url" value="buy_life.php?policy=<?php echo isset($_GET['policy']) ? intval($_GET['policy']) : ''; ?>">
                ...
                <button type="submit" class="btn btn-primary">Purchase Life Policy</button>
            </form>
        <?php endif; ?>
    </main>
    <footer>
