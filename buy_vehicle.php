<?php
// buy_vehicle.php - Vehicle policy purchase form
session_start();
...
if (isset($_GET['policy'])) {
    ...
    $stmt = $conn->prepare("SELECT policy_name, premium FROM policies WHERE id = ? AND type = 'Vehicle'");
...
<body>
    ...
    <main class="container">
        <h1>Vehicle Insurance - <?php echo htmlspecialchars($policy_name); ?></h1>
        <div class="card">
        ...
        <?php else: ?>
            ...
            <form class="flex-form" action="process_buy.php" method="POST">
                ...
                <input type="hidden" name="policy_type" value="Vehicle">
                <input type="hidden" name="return_url" value="buy_vehicle.php?policy=<?php echo isset($_GET['policy']) ? intval($_GET['policy']) : ''; ?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="reg_number" required placeholder="e.g., DL01AB1234">
                </div>
                <div class="form-group">
                    <label>Vehicle Make/Model</label>
                    <input type="text" name="vehicle_model" required placeholder="e.g., Maruti Swift">
                </div>
                <div class="form-group">
                ...
                <button type="submit" class="btn btn-primary">Purchase Vehicle Policy</button>
            </form>
        <?php endif; ?>
    </main>
    <footer>
